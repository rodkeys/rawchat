...
export default class UiStore {
  ...
  @computed
  get roomProfilePanelIsOpen() {
    return this._roomProfilePanelOpened
  }
  ...
  @action.bound
  openRoomProfilePanel() {
    this._roomProfilePanelOpened = true
  }

  @action.bound
  closeRoomProfilePanel() {
    this._roomProfilePanelOpened = false
  }
  ...
  @computed
  get useSuggestedModeration() {
    return this.settingsStore.uiSettings.useSuggestedModeration
  }

  set useSuggestedModeration(val) {
    this.settingsStore.uiSettings.useSuggestedModeration = val
  }
