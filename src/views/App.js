...
const Disclaimer = React.lazy(() => import( /* webpackChunkName: "LoginForm" */ '../components/Disclaimer'))
...
const ExploreRoomsView = React.lazy(() => import( /* webpackChunkName: "LoginView" */ './ExploreRoomsView'))
